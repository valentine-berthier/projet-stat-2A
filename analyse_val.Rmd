...
ODD_REG <- read_delim("donnees/cofacteurs/ODD_REG.csv", 
+     delim = ";", escape_double = FALSE, trim_ws = TRUE)

Evol_nb_degjours_REG<-ODD_REG%>%
...
Evol_nb_degjours_REG$codgeo<-nreg

save(Evol_nb_degjours_REG,file="donnees/cofacteurs/nb_degjours_REG.rdata")
...
save(PIB_revenu_national_12_21,file="donnees/cofacteurs/PIBrevenu_national_12_21.rdata")
```
