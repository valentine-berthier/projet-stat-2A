...
Nous observons des données hétéroscédastiques par population, en EHPAS la variance est bien plus grande qu'en ville. Il sera possible de tester ce critère à l'aide d'un test d'homoscédasticité. De plus, on ne remarque pas de données proche des bornes de l'intervalle, cela justifie également le fait d'utiliser une régression bêta.
