...
<<<<<<< HEAD
# comment as-tu trouvé ces valeurs que tu remplaces ? 

usage_animal2$population <- as.factor(usage_animal$population)
=======
>>>>>>> a0bc0f1b5ce372564483d07f145eeb44f4b6b5c3
...
ggplot(data = usage_animal2, aes(x = `valeur AMR`, y = Valeur_AMU))+
  geom_point()+ 
  theme_minimal()+                     
  labs(x = "Sensibilité aux antibiotiques",
       y = "Usage d'antibiotiques",
...
```
En violet, un échantillon suivant une loi bêta de paramètres renseignés dans ce document : file:///C:/Users/flori/Downloads/v34i02-1.pdf. Peut-être qu'avec ça on peut conclure quant à l'utilisation de la régression bêta mais je n'en suit vraiment pas sûre.
...
model_beta <- betareg(data = usage_animal, `valeur AMR` ~ Valeur_AMU + population, link = "logit")
summary(model_beta)
