...
On peut valider l'hypothèse d'homogénéité des variances pour annee et region mais pas pour population, cela signifie que les variances ne sont pas homogènes dans les différents groupes. Attention donc à l'interprétation. Les autres hypothèses sont cependant vérifiées.
