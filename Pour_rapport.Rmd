...
for (pop in unique(usage_animal$population)){
  ...
  print(pop)
  print(predictions)
  table_prediction <- cbind(pop, predictions * 100, predictions_IC)
...
for (pop in unique(usage_humain$population)){
  ...
  predictions_IC <- predict(model_beta, newdata = usage_prediction_filtre, interval = "prediction", type = "quantile", at = c(0.05, 0.95))
  print(pop)
  table_prediction <- cbind(pop, unique(usage_prediction_filtre$region), predictions * 100, predictions_IC)
...
colnames(mes_predictions_humains) <- c("population", "region", "estimation", "vraie valeur", "borne_inf", "borne_sup")
...
colnames(mes_predictions_animaux) <- c("population", "estimation", "vraie valeur", "borne_inf", "borne_sup")
