...
# Liste pour stocker les résultats des ANOVAs par population
anova_results <- list()

# Boucle sur les niveaux de la variable "population"
...
############## IL FAUT DEGAGER LES PUTAINS DE COCHONS ABATTORORREIORI
