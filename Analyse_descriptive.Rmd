...
```{r}
usage_animal <- read_excel("donnees/D_animale_nationale_avec_alea_corrige.xlsx")
```
...
Une regression bêta est privilégiée car on alasye la proportion d'animaux sensibles aux antibiotiques.
Il faudra utiliser la fonction betar du package mgcv.