...
Les dispositifs se concentrent sur une seule population, par exemple Medual-Ville ne récupère que les valeurs AMR pour la population humaine (en ville).
...
AMR$groupe_population <- "Animaux de production"
AMR$groupe_population[c(which(AMR$population=='Chien'|AMR$population=='Chat'))] <- "Animaux domestiques"
AMR_fr <- AMR[which(AMR$region=='Nationale'),]
ggplot(AMR_fr, aes(x = population, y = 'effectif AMR'))+
  geom_col()
```
